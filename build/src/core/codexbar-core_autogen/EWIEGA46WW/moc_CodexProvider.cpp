...
#include "../../../../../src/core/CodexProvider.h"
...
namespace {
struct qt_meta_tag_ZN13CodexProviderE_t {};
} // unnamed namespace

template <> constexpr inline auto CodexProvider::qt_create_metaobjectdata<qt_meta_tag_ZN13CodexProviderE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<CodexProvider, qt_meta_tag_ZN13CodexProviderE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject CodexProvider::staticMetaObject = { {
    QMetaObject::SuperData::link<Provider::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13CodexProviderE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13CodexProviderE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN13CodexProviderE_t>.metaTypes,
    nullptr
} };

void CodexProvider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    auto *_t = static_cast<CodexProvider *>(_o);
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->onProcessStarted(); break;
...
void *CodexProvider::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13CodexProviderE_t>.strings))
